...
namespace wages {
    ...
    public partial class Database1DataSet4 : global::System.Data.DataSet {
        ...
        public partial class wageDataTable : global::System.Data.TypedTableBase<wageRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public wageRow AddwageRow(int Id, string name, int hours, int wage, string designation) {
        ...
        public partial class wageRow : global::System.Data.DataRow {
            ...
            public string designation {
                get {
                    try {
                        return ((string)(this[this.tablewage.designationColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'designation\' in table \'wage\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablewage.designationColumn] = value;
                }
            }
            ...
            public bool IsdesignationNull() {
                return this.IsNull(this.tablewage.designationColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetdesignationNull() {
                this[this.tablewage.designationColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace wages.Database1DataSet4TableAdapters {
    ...
    public partial class wageTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[wage] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_hours = 1 AND [hours] IS NULL) OR ([hours] = @Original_hours)) AND ((@IsNull_wage = 1 AND [wage] IS NULL) OR ([wage] = @Original_wage)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[wage] ([Id], [name], [hours], [wage], [designation]) VALUES (@" +
                "Id, @name, @hours, @wage, @designation);\r\nSELECT Id, name, hours, wage, designat" +
                "ion FROM wage WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[wage] SET [Id] = @Id, [name] = @name, [hours] = @hours, [wage] = @wage, [designation] = @designation WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_hours = 1 AND [hours] IS NULL) OR ([hours] = @Original_hours)) AND ((@IsNull_wage = 1 AND [wage] IS NULL) OR ([wage] = @Original_wage)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)));
SELECT Id, name, hours, wage, designation FROM wage WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, hours, wage, designation FROM dbo.wage";
        ...
        public virtual int Fill(Database1DataSet4.wageDataTable dataTable) {
        ...
        public virtual Database1DataSet4.wageDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet4.wageDataTable dataTable = new Database1DataSet4.wageDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet4.wageDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, global::System.Nullable<int> Original_hours, global::System.Nullable<int> Original_wage, string Original_designation) {
        ...
        public virtual int Insert(int Id, string name, global::System.Nullable<int> hours, global::System.Nullable<int> wage, string designation) {
        ...
        public virtual int Update(int Id, string name, global::System.Nullable<int> hours, global::System.Nullable<int> wage, string designation, int Original_Id, string Original_name, global::System.Nullable<int> Original_hours, global::System.Nullable<int> Original_wage, string Original_designation) {
            ...
            if ((Original_wage.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_wage.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> hours, global::System.Nullable<int> wage, string designation, int Original_Id, string Original_name, global::System.Nullable<int> Original_hours, global::System.Nullable<int> Original_wage, string Original_designation) {
            return this.Update(Original_Id, name, hours, wage, designation, Original_Id, Original_name, Original_hours, Original_wage, Original_designation);
        }
    }
