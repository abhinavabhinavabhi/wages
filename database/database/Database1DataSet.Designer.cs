...
namespace database {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public employeeRow AddemployeeRow(int Id, string name, string dept) {
...
namespace database.Database1DataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employee] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 " +
                "AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_dept = 1 AND [de" +
                "pt] IS NULL) OR ([dept] = @Original_dept)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([Id], [name], [dept]) VALUES (@Id, @name, @dept);\r\n" +
                "SELECT Id, name, dept FROM employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [Id] = @Id, [name] = @name, [dept] = @dept WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_dept = 1 AND [dept] IS NULL) OR ([dept] = @Original_dept)));
SELECT Id, name, dept FROM employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, dept FROM dbo.employee";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_dept) {
        ...
        public virtual int Insert(int Id, string name, string dept) {
        ...
        public virtual int Update(int Id, string name, string dept, int Original_Id, string Original_name, string Original_dept) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string dept, int Original_Id, string Original_name, string Original_dept) {
            return this.Update(Original_Id, name, dept, Original_Id, Original_name, Original_dept);
        }
    }
